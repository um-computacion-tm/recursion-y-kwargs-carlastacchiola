    ...
    class TestBuscarDatos(unittest.TestCase):
     def setUp(self):
        ...
        def test_persona_existente(self):
         resultado = buscar_datos("Juan", "Manuel", "Rodriguez", "Sosa", database=self.database)
        ...
        def test_busqueda_flexible(self):
          resultado = buscar_datos("Manuel", "Juan", "Sosa", "Rodriguez", database=self.database)
          self.assertEqual(resultado, 1)        
          
          resultado = buscar_datos("Rodriguez", "Juan", "Manuel", "Sosa", database=self.database)
